...
# Form implementation generated from reading ui file 'UIproject_4.ui'
#
...
class Ui_MainWindow_4(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1136, 902)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit.setGeometry(QtCore.QRect(220, 10, 661, 911))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_4.setText(_translate("MainWindow", "Шрифт"))
        self.action_5.setText(_translate("MainWindow", "Цвет шрифта"))
        self.action_6.setText(_translate("MainWindow", "Фон"))
        self.action_7.setText(_translate("MainWindow", "Добавить фон"))
